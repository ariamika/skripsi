...
if(isset($_POST['adduser']))
	{
		...
		$tambahuser = mysqli_query($conn,"insert into login (namalengkap, email, password, notelp, alamat,wilayah) 
		values('$nama','$email','$pass','$telp','$alamat',$wilayah)");
		if ($tambahuser){
				...
				<form method="post">
					...
					<?php
						...
						echo "cURL Error #:" . $err;
							...
							var_dump($curl_response["rajaongkir"]);

							foreach ($curl_response["rajaongkir"]["results"] as $key => $value) {
								var_dump($value);
