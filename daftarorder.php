...
if (isset($_POST['selesai'])) {
    ...
    if ($updatestatus) {
        echo " <div class='alert alert-success'>
			<center>Transaksi telah diselesaikan.</center>
		  </div>
		  <meta http-equiv='refresh' content='1; url= cart.php'/>";
    } else {
...
<head>
    <title>Yadabagasket - Daftar Belanja</title>
    <!-- for-mobile-apps -->
            ...
            <div class="checkout-right">
                <table class="timetable_sub">
                    ...
                    <?php 
						...
						$brg=mysqli_query($conn,"SELECT DISTINCT(idcart), c.orderid, tglorder, resinumber, status from cart c, detailorder d where c.userid='$uid' and d.orderid=c.orderid and status!='Cart' order by tglorder DESC");
						$no=1;
                    ...
                    <tr class="rem1">
                        <form method="post">
                            ...
                            <td class="invert"><a href="order.php?id=<?php echo $b['orderid']; ?>"><?php echo $b['orderid']; ?></a>
                            </td>
                            ...
                            <td class="invert">
                                <div class="rem">
                                    <?php
                                    if ($b['status'] == 'Payment') {
                                        echo '<a href="konfirmasi.php?id=' . $b['orderid'] .'" class="form-control btn-primary">
												Konfirmasi Pembayaran
											</a>';
                                    } elseif ($b['status'] == 'Pengiriman') {
                                        echo '<a href="https://cekresi.com/?v=wdg&noresi=' . $b['resinumber'] . '" class="form-control btn-primary text-decoration-none mb-2" style="margin-bottom: 5px;" target="_blank">
												(Pembayaran Terkonfirmasi) Lacak Pengiriman
											</a>
											<form method="post">
												<input type="hidden" name="orderid" value="'.$b['orderid'].'">
												<input type="submit" name="selesai" class="form-control btn btn-success" value="Selesaikan Pesanan" \>
											</form>';
