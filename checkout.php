...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Yadabagasket</span></h1>
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert"><?php
						 $subtotal_berat = $b['berat_produk'] * $b['qty'];
						 echo $subtotal_berat;
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket" style="width:80%;">
					<h4>Ongkir</h4>
					<ul>
						
					<?php 
						$wilayah=mysqli_query($conn,"SELECT wilayah from login where userid='$uid'")->fetch_object()->wilayah;
						$ongkir = 10000 * $wilayah ;
						$total_ongkir = $total_berat * $ongkir;
						?>
						
						<h1><input type="text" value="<?php echo $total_ongkir ?>" ></h1>
					</ul>
				</div>
				<div class="checkout-left-basket" style="margin-top:60px;">
					...
					<ul>
						...
						<h1><input type="text" value="Rp<?php echo number_format($total_ongkir+$subtotal) ?>" disabled \></h1>
					</ul>
				</div>
				<br>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Arya B, Tangerang Selatan.</li>
