...
<head>
    <title>Yadabagasket - Konfirmasi Pembayaran</title>
    <!-- for-mobile-apps -->
        ...
        <div class="container">
            ...
            <div class="login-form-grids">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <br>
                    <b class="text-uppercase">Tanggal Bayar</b>
                    <input type="date" class="form-control" name="tanggal" value="<?php echo date('Y-m-d'); ?>">
                    <br />
                    <b class="text-uppercase">Upload Bukti Pembayaran</b>
