...
if (isset($_POST['update'])) {
    ...
    $update_cart = mysqli_query($conn, 'DELETE FROM cart WHERE orderid = (SELECT orderid FROM cart c WHERE NOT EXISTS (SELECT orderid FROM detailorder d WHERE c.orderid = d.orderid))');
...
<head>
    <title>Yadabagasket - Keranjang Saya</title>
    <!-- for-mobile-apps -->
