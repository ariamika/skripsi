...
<head>
    <title>Yadabagasket - Kategori</title>
    <!-- for-mobile-apps -->
                    ...
                    <ul class="cate">
                        ...
                        <?php 
														...
														while($p=mysqli_fetch_array($kat)){
															...
															?>
                        <li><a href="kategori.php?idkategori=<?php echo $p['idkategori']; ?>"><i class="fa fa-arrow-right"
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                ...
                                                <h4>Rp<?php
                                                if ($role === 'Supplier') {
                                                    echo number_format($p['hargaafter']);
                                                } else {
                                                    echo number_format($p['hargabefore']);
                                                }
                                                ?>
                                                </h4>
                                            </div>
